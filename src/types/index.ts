...
export type TabType = 'dashboard' | 'agents' | 'squads' | 'chat' | 'workflows' | 'artifacts' | 'analytics' | 'admin' | 'gamification' | 'instant-prd' | 'reality-mode' | 'meeting-minutes' | 'raci-generator' | 'epic-to-stories';
