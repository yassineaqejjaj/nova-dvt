...
const STEPS: { key: FlowStep; label: string; number: number }[] = [
  { key: 'sprint-setup', label: 'Sprint', number: 1 },
  { key: 'team', label: 'Équipe', number: 2 },
  { key: 'absences', label: 'Absences', number: 3 },
  { key: 'meetings', label: 'Réunions', number: 4 },
  { key: 'result', label: 'Capacité', number: 5 },
];
